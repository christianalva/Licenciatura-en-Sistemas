...
procedure agregarNom(var v:vector; dimL:integer);
var 
    i, j, x, pos:integer;
    nombre:string;
begin 
    ...
    readln(nombre);
    write('En que posicion quiere ingresarlo?: ');
    readln(pos);
    
    //nombreAnt:=v[pos];
    
    if(dimL<(pos-1)) then begin
        writeln('El vector posee menos de ', pos, ' posiciones');
    end
    else
    begin
