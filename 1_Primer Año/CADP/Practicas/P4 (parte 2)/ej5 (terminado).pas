...
//leo la informacion por teclado
...
procedure superanMP(var v:vector; var dimL:integer);
var
    i, x, superan:integer;
    montoTotal, montoPromedioTotal:real;
begin 
    montoTotal:=0;
    superan:=0;
    ...
    montoPromedioTotal:=(montoTotal/dimL);
    writeln();
    writeln('El promedio entre todos los clientes es de: ', montoPromedioTotal:2:2);
    for x:=1 to dimL do begin 
        if(montoPromedioTotal<v[x].montoMensual) then begin
            superan:=superan+1;
            writeln('El cliente ', x, ' supera el promedio total, con un monto mensual de: ', v[x]. montoMensual:2:2);
        end;
    end;
    writeln();
    writeln('En total los clientes que superan el promedio total es de: ', superan, ' clientes.');
end;
