...
type
  ...
  publicaciones=record // 4 bytes TOTAL
    cant:integer;//4 bytes 
  end;
  vector=array[1..max] of publicaciones; // 12*4=48 bytes
  
  informacion=record // 31+11+4 = 46 bytes
    titulo:string[30];//31 bytes
    nombreA:string[10];// 11 bytes
    DNI:integer;//4 bytes
  end;
...
// en total tiene 4+46+48 = 98 bytes de memoria ESTATICA